...
@section('content')
    ...
    <div class="content">
        ...
        {!! Form::open(['route' => 'promo.store', 'method' => 'POST']) !!}
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            {!! Form::submit('Save', ['class' => 'btn btn-primary', 'id' => 'btnAddPromo']) !!}
        ...
        $(document).ready(function () {
            $(function () {
                                ...
                                if ($('.id_barang_' + response.id).length == 0) {
                                    $('tbody').append(
                                        "<tr class='id_barang_" + response.id + "'>" +
                                            ...
                                            "<td><span>" + formatRupiah(harga * jumlah, "Rp. ") + "</span></td>" +
                                            "<td>" +
                                    ...
                                    $('.id_barang_' + response.id).children().eq(3).html(formatRupiah(subtotal_barang,"Rp. "));
                ...
                $("tbody").on('click', '.barang_delete', function () {
                    subtotal -= parseInt($(this).parent().siblings().eq(3).children().html().replace(/[^,\d]/g, ""));
