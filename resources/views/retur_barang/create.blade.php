        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    ...
                    {!! Form::open(['route' => 'returBarang.store', 'id' => 'formReturBarang']) !!}

                        @include('retur_barang.fields')
                        
                        @include('retur_barang.blist')
        ...
        $(document).ready(function(){
            $(function(){                            
                ...
                $("#formReturBarang").submit(function(e){
                    ...
                    var keterangan = dataBarang.find(({keterangan}) => {
                        return keterangan == '';
                    })
                    ...
                    if(keterangan === undefined){
                        if (Object.keys(values).length === 4) {
                            if(dataBarang.length != 0 ){
                                $(".overlay").show();
                                $.post(apiUrl + 'retur_barang', values, function(res) {
                                    ...
                                    if (res.success) {
                                        ...
                                        for (var i = 0; i < dataBarang.length; i++) {
                                            ...
                                            $.post(apiUrl + 'barang_retur', baranr, function(e) {
                                                if (!e.success) {
                                                    swal({
                                                        type: "warning",
                                                        title: "Error",
