...
<!-- Penjualan Id Field -->
<div class="form-group col-sm-6">
    {!! Form::label('penjualan_id', 'Penjualan:') !!}
    {!! Form::select('penjualan_id', $penjualanItems, null, ['class' => 'select2 form-control']) !!}
</div>
...
<!-- Tanggal Field -->
@if(Request::is('kartuStokPenjualan/*/edit'))
<div class="form-group col-sm-6">
    {!! Form::label('tanggal', 'Tanggal:') !!}
    {!! Form::date('tanggal', $kartuStokPenjualan->tanggal, ['class' => 'form-control','id'=>'tanggal']) !!}
</div>
@else
<div class="form-group col-sm-6">
    {!! Form::label('tanggal', 'Tanggal:') !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('kartuStokPenjualan.index') }}" class="btn btn-default">Cancel</a>
</div>
