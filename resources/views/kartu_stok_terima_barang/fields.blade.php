...
<div class="form-group col-sm-6">
    {!! Form::label('terima_barang_id', 'Terima Barang:') !!}
    {!! Form::select('terima_barang_id', $terimaBarangItems, null, ['class' => 'select2 form-control']) !!}
</div>
...
<!-- Tanggal Field -->
@if(Request::is('kartuStokTerimaBarang/*/edit'))
<div class="form-group col-sm-6">
    {!! Form::label('tanggal', 'Tanggal:') !!}
    {!! Form::date('tanggal', $kartuStokTerimaBarang->tanggal, ['class' => 'form-control','id'=>'tanggal']) !!}
</div>
@else
<div class="form-group col-sm-6">
    {!! Form::label('tanggal', 'Tanggal:') !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('kartuStokTerimaBarang.index') }}" class="btn btn-default">Cancel</a>
</div>
